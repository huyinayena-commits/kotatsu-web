    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
            ...
            <main className="container mx-auto px-4 py-8">
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full px-6 py-4 pl-14 bg-slate-800/50 border border-slate-700 rounded-2xl 
                                     ...
                                     focus:ring-2 focus:ring-purple-500/20 transition-all text-lg"
                        />
                ...
                {/* Results */}
                {error && (
                    <div className="bg-red-500/10 border border-red-500/30 rounded-2xl p-6 text-center max-w-2xl mx-auto">
